			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-4 col-md-4 col-lg-5">
					<div class="form-group">
                        ...
                        <input type="text" placeholder="Search Party" class="form-control" id="search" name="search">
                    </div>
					<div class="form-group">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<table class="table table-bordered table-striped table-vcenter" id="invoiceItem">
						...
						<tr>
                            ...
                            <td><select class="form-control" id="example-select" name="example-select">
                                    <option value="0">Please select</option>
                                    <option value="1">Sq.ft</option>
                                    <option value="2">RFT</option>
...
<!-- Mirrored from phpzag.com/demo/build-invoice-system-with-php-mysql-demo/create_invoice.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Oct 2019 06:04:13 GMT -->
</html>
@endsection
